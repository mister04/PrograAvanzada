...
namespace ProyectoProgra
{
    ...
    public class ApplicationUserManager : UserManager<ApplicationUser, string>
    {
        ...
        {
            var manager = new ApplicationUserManager(new UserStore<ApplicationUser, Roles, string, IdentityUserLogin, IdentityUserRole, IdentityUserClaim>(context.Get<ApplicationDbContext>()));
    ...
    public class ApplicationRolesManager : RoleManager<Roles>
    {
        public ApplicationRolesManager(IRoleStore<Roles,string> store) 
            : base(store)
        {

        }
        public static ApplicationRolesManager Create(IdentityFactoryOptions<ApplicationRolesManager> options,
            IOwinContext context)
        {
            return new ApplicationRolesManager(new RoleStore<Roles>(context.Get<ApplicationDbContext>()));  
        }
    }
